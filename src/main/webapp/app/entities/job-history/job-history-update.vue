  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="jhipsterSampleProdApp.jobHistory.home.createOrEditLabel"
          data-cy="JobHistoryCreateUpdateHeading"
          v-text="t$('jhipsterSampleProdApp.jobHistory.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterSampleProdApp.jobHistory.startDate')" for="job-history-startDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterSampleProdApp.jobHistory.endDate')" for="job-history-endDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterSampleProdApp.jobHistory.language')" for="job-history-language"></label>
            <select
              class="form-control"
              name="language"
            ...
            >
              <option
                ...
                :key="language"
                :value="language"
                :label="t$('jhipsterSampleProdApp.Language.' + language)"
              >
                {{ language }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterSampleProdApp.jobHistory.job')" for="job-history-job"></label>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jhipsterSampleProdApp.jobHistory.department')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterSampleProdApp.jobHistory.employee')" for="job-history-employee"></label>
