...
To build the final jar and optimize the jhipsterSampleProd application for production, run:
...
[![Open](https://img.shields.io/static/v1?label=Open%20in&message=Developer%20Sandbox&logo=eclipseche&color=FDB940&labelColor=525C86)](https://workspaces.openshift.com/#https://github.com/maximilianoPizarro/jhipster-sample-prod)
